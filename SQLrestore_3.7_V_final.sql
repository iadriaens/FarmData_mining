...
INSERT INTO @ListTables VALUES ('AnimalHistoricalData')
INSERT INTO @ListTables VALUES ('DailyMilk')
...
INSERT @PreFilesCmdshell2 (outputCmd,depth,isfile) EXEC master.sys.xp_dirtree 'C:\Users\u0084712\Documents\Box Sync\Documents\MastiMan\Data\Data sets\Backup files\Delaval\A1_3.7_V\',1,1;
...
BEGIN
	SET @Prelocationinput = 'C:\Users\u0084712\Documents\Box Sync\Documents\MastiMan\Data\Data sets\Backup files\Delaval\A1_3.7_V\'+@PreFilesCmdshellOutputCmd
...
-- RESTORE DATABASES
	...
	IF dbo.fc_FileExists('C:\Users\u0084712\Documents\Box Sync\Documents\MastiMan\Data\Data sets\Backup files\testSQLOUTPUT1\' + SUBSTRING(@FilesCmdshellOutputCmd, 0, len(@FilesCmdshellOutputCmd)+1)+'\DelPro.bak') = 1
		BEGIN
			...
			SET @sqlRestore  = 'RESTORE DATABASE [DDMVMS] 
				...
				MOVE N''DDMVMS'' TO N''C:\Users\u0084712\Documents\Box Sync\Documents\MastiMan\Data\Data sets\Backup files\testSQLOUTPUT2\' + SUBSTRING(@FilesCmdshellOutputCmd, 0, len(@FilesCmdshellOutputCmd)+1)+ '.mdf'', 
				MOVE N''DDMVMS_log'' TO N''C:\Users\u0084712\Documents\Box Sync\Documents\MastiMan\Data\Data sets\Backup files\testSQLOUTPUT2\' + SUBSTRING(@FilesCmdshellOutputCmd, 0, len(@FilesCmdshellOutputCmd)+1) + '_log.ldf'', NOUNLOAD,  STATS = 10'
			EXEC(@sqlRestore)
...
-- EXPORT TABLES OF THE RESTORED DATABASE
				...
				BEGIN
					...
					SELECT COLUMN_NAME from DDMVMS.INFORMATION_SCHEMA.COLUMNS where TABLE_NAME=@SelectedTable;
