...
opts.SelectedVariableNames = {'OID','Number','OffRegNumber','BirthDate'};% selected variable names
...
col_OUT = {'OfficialRegNo','BA','Number','BDate','Calving','Lac','Date','DIM','TDMY','A7DY','Dur','Milkings','Kickoffs','Incompletes'};
% prepare indices
...
SUM.NUniLac(1,1) = length(unique(OUT{:,[2 6]},'rows'));
