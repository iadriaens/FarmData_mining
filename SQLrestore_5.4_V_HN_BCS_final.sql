...
---- Directories:
DECLARE @DirInputData NVARCHAR(MAX) = 'C:\Users\u0132268\Box Sync\LORE\MastiManResearch\Github\FarmData_mining\1.INPUTDATA\Delaval\A4_5.4_V_HN_BCS\'
...
------------------------------------------------ C. CHOOSE OUTPUT TABLES Section (A4_5.4_V_HN_BCS) ----------------------------------------------------------------------------
