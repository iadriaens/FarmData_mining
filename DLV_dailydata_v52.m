function OUT = DLV_dailydata_v52(cd,FN_HA,FN_HALI,FN_HADD,cd_H,temp_dir)
...
opts.SelectedVariableNames = {'OID','DayDate','Animal','DIM','LactationNumber','DailyYield','Last7DayAvg','MilkingDurationInSec','Milkings','Kickoffs','Incompletes'};% selected variable names
opts = setvartype(opts,{'OID','Animal','DIM','LactationNumber','DailyYield','Last7DayAvg','MilkingDurationInSec','Milkings','Kickoffs','Incompletes'},'double');% set var type to double
...
c.Properties.VariableNames = {'OID2','Date','RefID','DIM','Lac','TDMY','A7DY','Dur','Milkings','Kickoffs','Incompletes'};  % HADD
...
c = sortrows(c,{'RefID','Date'});

OUT = sortrows(innerjoin(a,c,'LeftKeys',{'BA'},'RightKeys',{'RefID'}),{'RefID','Date'});       % join HADD and HALI
