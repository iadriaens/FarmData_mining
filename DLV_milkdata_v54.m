function OUT = DLV_milkdata_v54_HN_BCS(cd,FN_BA,FN_ALS,FN_SMY,FN_VMY,cd_H,temp_dir)
...
% clear variables
clear idx_ALS idx_BA idx_AHD idx_VMY idx_SMY exttype opts ans m dates dates1 dates2
