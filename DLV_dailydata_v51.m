function OUT = DLV_dailydata_v51(cd,FN_HA,FN_HALI,FN_HADD,cd_H,temp_dir)
...
opts.SelectedVariableNames = {'OID','Number','OffRegNumber','Name','BirthDate'};% selected variable names
...
col_OUT = {'OfficialRegNo','BA','Number','Name','BDate','Calving','Lac','Date','DIM','TDMY','A7DY','Dur','Milkings','Kickoffs','Incompletes'};
% prepare indices
